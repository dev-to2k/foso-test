...
export default function BlogContent() {
  return (
    <div className="prose max-w-none font-medium text-[#231F20]">
      <h2 className="text-2xl font-bold text-[#15AA7A] mb-4">
      ...
      <ul className="list-none pl-0 mb-4">
        <li className="flex items-start mb-2">
          ...
          <span>
            <span className="text-[#15AA7A] font-medium">Seiri</span> (Ngăn nắp)
          </span>
        </li>
        <li className="flex items-start mb-2">
          <span className="text-[#15AA7A] font-medium mr-2">•</span>
          <span>
            <span className="text-[#15AA7A] font-medium">Seiso</span> (Sạch sẽ)
          </span>
        </li>
        <li className="flex items-start mb-2">
          <span className="text-[#15AA7A] font-medium mr-2">•</span>
          <span>
            <span className="text-[#15AA7A] font-medium">Seiton</span> (Trật tự)
          </span>
        </li>
        <li className="flex items-start mb-2">
          <span className="text-[#15AA7A] font-medium mr-2">•</span>
      ...
      <h3 className="text-xl font-bold text-[#15AA7A] mb-2">
      ...
      <p className="mb-4">
        Trong giai đoạn chuẩn bị, doanh nghiệp cần bố trí nhân lực đúng để điều
        hành và quản lý quá trình thực hiện quy trình 5S. Việc phân bố cụ thể
      ...
      <h3 className="text-xl font-bold text-[#15AA7A] mb-2">5.5 Đánh giá</h3>
      <p className="mb-4">
      ...
      <ul className="list-none pl-0 mb-4">
        <li className="flex items-start mb-2">
          ...
          <span>
            ...
            đây là yếu tố quan trọng nhất để quyết định doanh nghiệp có áp dụng
        ...
        <li className="flex items-start mb-2">
          ...
          <span>
            ...
            đồng ý, doanh nghiệp cần bộ phận đưa ra ý tưởng, kế hoạch thực hiện
            triển khai 5S.
          </span>
        </li>
        <li className="flex items-start mb-2">
